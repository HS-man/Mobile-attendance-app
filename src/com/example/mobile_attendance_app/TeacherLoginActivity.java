...
import com.example.mobile_attendance_app.StudentLoginActivity.LoginThread;
...
public class TeacherLoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	_username=(EditText) findViewById(R.id.teacher_username);
    	_password=(EditText) findViewById(R.id.teacher_password);
 	    ...
 	    public void handleMessage(Message msg) {
 	        ...
 	        if(msg.what==0){
 	        	...
 	        	if(result.equals("1")){
 	    			...
 	    			Toast.makeText(TeacherLoginActivity.this, "fail", Toast.LENGTH_SHORT).show();
 	    		}
 	        }
 	    }
 	};
